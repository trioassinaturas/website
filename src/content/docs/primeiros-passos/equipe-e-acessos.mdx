...
<Callout type="warning" title="Acesso ao painel ainda é acesso amplo">
  Mesmo como Membro, quem entra no painel enxerga dados de clientes e cobranças.
  Dê acesso a quem precisa operar, e prefira o [acesso como
  assinante](/docs/operacao/clientes-e-leads) para quem só precisa investigar um
  caso pontual.
</Callout>
...
nem desativada por essa tela, e a função Proprietário não pode ser atribuída a
mais ninguém. Para transferir a titularidade da conta, fale com o suporte.
