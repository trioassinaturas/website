...
<Callout type="info" title="Depois de publicar, um rascunho novo é criado">
  ...
  página ao vivo, mesmo logo depois de publicar.
</Callout>
...
<Callout type="warning" title="Produtos/Checkout desligada esconde os planos">
  ...
  desligada não aparece na página, e sem ela a loja fica sem os cartões de plano
  e sem os botões de assinar. É a causa mais provável de uma loja bonita que não
  vende.
</Callout>
...
<Callout type="info" title="Imagem salva se troca, não se remove">
  Não existe um botão para deixar uma seção sem imagem depois que ela já foi
  salva com uma. Dá para trocar por outra, e dá para apagar a seção inteira e
  criar de novo sem foto. O “×” sobre a miniatura só cancela um arquivo que você
  acabou de escolher e ainda não salvou.
</Callout>
