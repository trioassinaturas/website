...
A ficha reúne tudo sobre a pessoa: dados de contato, CPF, telefone, endereços,
assinaturas, pedidos, cobranças, respostas de formulários e indicações. A lista
pode ser filtrada pela situação da assinatura (ativa, pausada, cancelada, ou sem
assinatura) e exportada em CSV e XLSX.
